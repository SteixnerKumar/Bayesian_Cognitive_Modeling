...
analysis infer the common rate $\theta$ to be? Do you believe the inference?

# Comments/Solution
In this example of the dataset we see that the individually the k1 and k2 are drastically different and show the two extreme probabilities of 0 and 1 respectively. But, since we have the model set up that a common rate (latent probability) controls both we see that the posterior estimate $\theta$ to be in the middle around 0.5. Check out the plots section.
