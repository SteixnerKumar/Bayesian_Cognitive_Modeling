...
```{r plot_chain_1, fig.align="center", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
# chain plot
x_limit <- c(0,200)
...
```{r plot_chain_2, fig.align="center", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
# chain plot
x_limit <- c(0,200)
...
```{r plot_chain_3, fig.align="center", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
# chain plot
x_limit <- c(0,200)
...
```{r plot_chain_4, fig.align="center", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
# chain plot
x_limit <- c(0,200)
...
#### plot for $\theta$ ~Beta(1,5)
```{r plot_posterior_3, fig.align="center", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
# Now let's plot a histogram/density for theta.
# Plot
...
#### plot for $\theta$ ~Beta(0.1,0.1)
```{r plot_posterior_4, fig.align="center", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
# Now let's plot a histogram/density for theta.
# Plot
...
#### plot for $\theta$ ~ Beta(1,1)
```{r plot_posterior_5, fig.align="center", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
...
#### plot for $\theta$ ~ Beta(10,10)
```{r plot_posterior_6, fig.align="center", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
# create the dataframe to pot using ggplot
df_plot <- data.frame(
  theta2 = theta2,
...
#### plot for $\theta$ ~ Beta(1,5)
```{r plot_posterior_7, fig.align="center", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
# create the dataframe to pot using ggplot
df_plot <- data.frame(
  theta3 = theta3,
...
#### plot for $\theta$ ~ Beta(0.1,0.1)
```{r plot_posterior_8, fig.align="center", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
# create the dataframe to pot using ggplot
df_plot <- data.frame(
  theta4 = theta4,
...
```{r plot_posterior_9, fig.align="center", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
# create the dataframe to pot using ggplot
df_plot <- data.frame(
  theta1 = theta1,
  theta2 = theta2,
...
# plot
ggplot(df_plot, aes(x=value,fill=parameter)) + 
  geom_density()+
